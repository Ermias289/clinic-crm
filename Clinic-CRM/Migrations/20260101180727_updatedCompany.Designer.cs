...
namespace Clinic_CRM.Migrations
{
    ...
    [Migration("20260101180727_updatedCompany")]
            ...
            modelBuilder.Entity("Clinic_CRM.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("Clinic_CRM.Models.MedicalService", "Dentistry")
                        .WithMany()
                        .HasForeignKey("DentistryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Clinic_CRM.Models.MedicalProfessional", "MedicalProfessional")
                        .WithMany()
