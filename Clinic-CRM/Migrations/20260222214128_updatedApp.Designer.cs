...
namespace Clinic_CRM.Migrations
{
    ...
    [Migration("20260222214128_updatedApp")]
    partial class updatedApp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Clinic_CRM.Models.DocService", b =>
                {
                    ...
                    b.HasOne("Clinic_CRM.Models.MedicalProfessional", "MedicalProfessional")
                        .WithMany("DocServices")
                        .HasForeignKey("MedicalProfessionalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Clinic_CRM.Models.MedicalService", "MedicalService")
                        .WithMany()
